...
#ifndef __TextureSynthesis__Graphcut__
#define __TextureSynthesis__Graphcut__
...
using namespace cv;
struct Dinic{
    static const int MAXN=22000,MAXM=440000;
    struct edge{
        int x,y;//两个顶点
        int c;//容量
        int f;//当前流量
...
class Graphcut{
public:
    static void graphchange(const string & filename, int coe);
};
#endif /* defined(__TextureSynthesis__Graphcut__) */
